...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "alertBody" : MessageLookupByLibrary.simpleMessage("Ви дійсно бажаете видалити цей нотаток"),
    "alertTitle" : MessageLookupByLibrary.simpleMessage("Видалити нотаток"),
    "anotherSettings" : MessageLookupByLibrary.simpleMessage("Інші налаштування"),
    "camera" : MessageLookupByLibrary.simpleMessage("Камера"),
    "cameraParameters" : MessageLookupByLibrary.simpleMessage(" Додати зображення з"),
    "cannotFindTeacher" : MessageLookupByLibrary.simpleMessage("Немає викладачів"),
    "change" : MessageLookupByLibrary.simpleMessage("Змінити"),
    "changeGroup" : MessageLookupByLibrary.simpleMessage("Змінити групу"),
    "changeNotes" : MessageLookupByLibrary.simpleMessage("Змінити нотаток"),
    "clear" : MessageLookupByLibrary.simpleMessage("Очистити"),
    "clearNotes" : MessageLookupByLibrary.simpleMessage("Очистити нотатки"),
    "colorSettings" : MessageLookupByLibrary.simpleMessage("Налаштування теми"),
    "confirm" : MessageLookupByLibrary.simpleMessage("Підтвердити"),
    "connectionProblem" : MessageLookupByLibrary.simpleMessage("Проблема з підключенням"),
    "correctInputGroup" : MessageLookupByLibrary.simpleMessage(" Введи свою групу правильно Введи свою групу правильно"),
    ...
    "firstLoading" : MessageLookupByLibrary.simpleMessage("Перше завантаження "),
    ...
    "homeScreenInput" : MessageLookupByLibrary.simpleMessage("Введіть свою групу\n(як в прикладі)"),
    "images" : MessageLookupByLibrary.simpleMessage("Зображення"),
    "languageChange" : MessageLookupByLibrary.simpleMessage("Змінити мову"),
    "loadError" : MessageLookupByLibrary.simpleMessage(" Не завантажується Не завантажується"),
    ...
    "noteFor" : MessageLookupByLibrary.simpleMessage("Нотатки для"),
    "notes" : MessageLookupByLibrary.simpleMessage("Нотатки"),
    "notesMessage" : MessageLookupByLibrary.simpleMessage("Для створення замітки\n натисніть два рази на урок"),
    "notesTooltip" : MessageLookupByLibrary.simpleMessage("Для створення посилання додайте # в початок слова"),
    "rating" : MessageLookupByLibrary.simpleMessage("Рейтинг"),
    "refresh" : MessageLookupByLibrary.simpleMessage("Оновити"),
    "room" : MessageLookupByLibrary.simpleMessage("Кабінет:"),
    ...
    "scheduleInternetError" : MessageLookupByLibrary.simpleMessage("не завантажується розклад \n Перевірте интенет з\'єднання"),
    ...
    "teacherFree" : MessageLookupByLibrary.simpleMessage("Викладач вільний"),
    "text" : MessageLookupByLibrary.simpleMessage("Текст"),
    "thurday" : MessageLookupByLibrary.simpleMessage("Четвер"),
    "title" : MessageLookupByLibrary.simpleMessage("Розклад КПІ"),
    ...
    "updateSchedule" : MessageLookupByLibrary.simpleMessage("Оновити розклад"),
